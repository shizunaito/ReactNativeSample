...
class PanResponderSample extends Component {
  ...
  // control the circle's position directly with setNativeProps.
  _updatePosition = () => {
    this.circle &&
  ...
  _handleStartShouldSetPanResponder = (event, gestureState) => {
    // become active when the user press down on the circle
    return true;
  };
  
  _handleMoveShouldSetPanResponder = (event, gestureState) => {
    // become active when ther user moves a touch over the circle
    return true;
  };
